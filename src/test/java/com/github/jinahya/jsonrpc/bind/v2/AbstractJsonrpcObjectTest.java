...
abstract class AbstractJsonrpcObjectTest<T extends AbstractJsonrpcObject> {
    ...
    @Test
    void testToString() {
        final String string = objectInstance().toString();
    ...
    void testIsContextuallyValid() {
        ...
        {
            assertTrue(((JsonrpcObject) validationProxy()).isContextuallyValid());
        }
    }

    // -----------------------------------------------------------------------------------------------------------------
    //@SuppressWarnings({"unchecked"})
    Object validationProxy() {
        if (validationProxy == null) {
            ...
            validationProxy = Proxy.newProxyInstance(classLoader, classInterfaces, invocationHandler);
        }
    ...
    private Object validationProxy;
