...
import static com.github.jinahya.jsonrpc.bind.v2.calculator.CalculatorController.PATH_VALUE_CALL;
...
public class CalculatorControllerTest {
    ...
    public void testForAdd() throws Exception {
        final AdditionParams params = new AdditionParams();
        ...
        final MvcResult mvcResult = mockMvc
                ...
                .andReturn();
        final CalculatorResponse calculatorResponse = OBJECT_MAPPER.readValue(mvcResult.getResponse().getContentAsString(), CalculatorResponse.class);
    ...
    public void testForSubtract() throws Exception {
        final SubtractionParams params = new SubtractionParams();
    ...
    public void testForMultiply() throws Exception {
        final MultiplicationParam params = new MultiplicationParam();
